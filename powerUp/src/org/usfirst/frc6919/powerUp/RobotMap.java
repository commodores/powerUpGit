...
public class RobotMap {
    ...
    public static Servo elevatorleftRaiseServo;
    public static Servo elevatorrightRaiseServo;
    public static PowerDistributionPanel smartDashboardpdp;
    ...
    public static void init() {
        ...
        elevatorleftRaiseServo = new Servo(5);
        LiveWindow.addActuator("elevator", "leftRaiseServo", elevatorleftRaiseServo);
        
        elevatorrightRaiseServo = new Servo(4);
        LiveWindow.addActuator("elevator", "rightRaiseServo", elevatorrightRaiseServo);
        
        smartDashboardpdp = new PowerDistributionPanel(10);
        LiveWindow.addSensor("smartDashboard", "pdp", smartDashboardpdp);
