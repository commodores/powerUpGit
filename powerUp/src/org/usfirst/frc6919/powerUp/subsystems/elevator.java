...
public class elevator extends Subsystem {
    ...
    private final Servo leftRaiseServo = RobotMap.elevatorleftRaiseServo;
    private final Servo rightRaiseServo = RobotMap.elevatorrightRaiseServo;
    ...
    public void intakeUp() {
    	rightRaiseServo.set(0.1);
    	leftRaiseServo.set(0.1);
    }
    
    public void intakeDown() {
    	rightRaiseServo.set(.9);
    	leftRaiseServo.set(.9);
    }    
