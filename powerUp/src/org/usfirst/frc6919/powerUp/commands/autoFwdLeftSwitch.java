 ...
 *
 */
public class autoFwdLeftSwitch extends Command {
    ...
    protected void execute() {
    	...
    	Robot.driveTrain.drive(.82, .72);
    }

    // Make this return true when this Command no longer needs to run execute()
    @Override
    protected boolean isFinished() {
        return Robot.driveTrain.getEncoderDistance() > 126 || isTimedOut();
    }
