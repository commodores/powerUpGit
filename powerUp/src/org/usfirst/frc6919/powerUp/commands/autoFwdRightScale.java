 ...
 *
 */
public class autoFwdRightScale extends Command {
    ...
    protected void execute() {
    	...
    	Robot.driveTrain.drive(0.8 + pTerm, 0.8 - pTerm);
    }

    // Make this return true when this Command no longer needs to run execute()
    @Override
    protected boolean isFinished() {
        return Robot.driveTrain.getEncoderDistance() > 224 || isTimedOut();
    }
